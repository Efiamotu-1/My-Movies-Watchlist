...
# 📖 Use Popcorn <a name="about-project"></a>

**[Use Popcorn]** is a movie sites and it uses components and compostion to display the user interface.
...
```sh
  cd my-folder
  git clone https://github.com/Efiamotu-1/use-popcorn.git
```
...
Feel free to check the [issues page](https://github.com/Efiamotu-1/use-popcorn/issues).
